...
public class SpawnData : ScriptableObject
{
    ...
    [SerializeField] private OneMoveColorData _davidColorData;
    ...
    public OneMoveColorData DavidColorData => _davidColorData;
    ...
    private void OnValidate()
    {
        ...
        TryCorrectLength(_davidColorData, _platformCount);
